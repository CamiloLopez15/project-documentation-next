        ...
        <>
            <div className="w-full h-full relative">
                <Canvas className="fixed top-0 left-0 w-full h-full z-0">
                    ...
                    <Stars radius={100} depth={50} count={300} factor={4} saturation={1} fade speed={.5}  />
                </Canvas>
                <header className="grid grid-cols-[50%_50%] w-full h-full row-span-1 absolute z-10 bg-transparent top-0">
                    <div className="flex flex-col justify-center items-start pl-48 text-lg col-span-1">
                        ...
                        <p className="mt-4 text-xl">
                            Has llegado a una de mis páginas webs, en esta
                            página web te hablaré a detalle en la forma en como
                            fueron construidos cada uno de mis proyectos.
                        </p>
                    </div>
